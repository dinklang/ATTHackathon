        ...
        <aside class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            <div class="h-full px-3 py-4 overflow-y-auto bg-att-dark">
                ...
                <ul class="space-y-2 font-medium pt-4">
                    <li>
                        <Link href="/" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white dark:hover:bg-att-grey">
                    ...
                    <li>
                        <Link href="/pokemon/Analytics" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white dark:hover:bg-att-grey">
                            <svg class="flex-shrink-0 w-6 h-5 bg-att" fill="#959595" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 490 490">
                                <g id="line_31_">
